...
| URL to /models API | https://oaica.samwong.com/models — **requires** `Authorization: Bearer <key>`; **you** paste the key from `~/.secrets/oaica_openrouter_key` (laptop) into the same form |
| API base URL | https://oaica.samwong.com/v1 |
| Privacy Policy URL | https://oaica.samwong.com/privacy |
| Terms of Service URL | https://oaica.samwong.com/terms |
...
| Status / health | https://oaica.samwong.com/status (statement) and https://oaica.samwong.com/health (200/503, for monitors) |
